    ...
    <div className="experience">
      <VerticalTimeline lineColor='#3e497a'>
        ...
        >
          ...
          <div className="experience-img">
            <img src="https://itmo.ru/file/pages/213/logo_na_plashke_russkiy_belyy.png" width='50%' />
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="experience-img">
            <img src="https://avatars.mds.yandex.net/get-bunker/135516/b5d842dd0e03a26c54749891dd1b0876edbae05d/orig" width='40%' />
          </div>
        </VerticalTimelineElement>
      </VerticalTimeline>
    </div>
